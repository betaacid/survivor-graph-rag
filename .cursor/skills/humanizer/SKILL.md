---
name: humanizer
description: Remove AI writing patterns to make text sound natural and human. Use when editing README, docs, or any prose. Based on Wikipedia's "Signs of AI writing" page.
---
...
6. Prompt: "What makes the below so obviously AI generated?" Answer briefly with the remaining tells (if any)
...
- Use this skill when editing README files, documentation, or any prose
- Use when updating project descriptions, release notes, or user-facing text
- Use when the agent is asked to write or revise any human-readable content
- Invoke explicitly with `/humanizer` when you want to humanize specific text
